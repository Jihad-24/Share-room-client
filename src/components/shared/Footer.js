      ...
      <footer className=" bg-[#000C21] py-5 md:px-0 px-10">
        <div className="lg:footer lg:text-start text-center py-10  text-white max-w-screen-xl mx-auto ">
          <nav>
            ...
            Quick Ship Room,Your Trusted Accommodation Partner
    Every Step of the Way. With our platform, you can expect nothing less than exceptional service, ensuring smooth and hassle-free housing experiences tailored to your needs.
            </p>
          </nav>
          {/* <nav>
          ...
          <nav>
            <header className="footer-title text-xl">She Share</header>
          ...
          <nav>
            ...
            <a className="link link-hover">Collection Policy</a>
            <a className="link link-hover">Legal Notice</a>
          ...
          <nav>
            <header className="footer-title  text-xl">Become a Host</header>

            <a className="link link-hover">Hosting Resources</a>
            <a className="link link-hover">Hosting Responsibility</a>
            <a className="link link-hover">Identity</a>
            <a className="link link-hover">Share a Room</a>
            <a className="link link-hover">Pets</a>
            <a className="link link-hover">Addresses</a>
          </nav>
          <nav>
            <header className="footer-title  text-xl">Terms & Privacy</header>
